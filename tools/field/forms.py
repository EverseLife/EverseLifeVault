...
климату, в порядке приоритета: вода, лёд, вулкан, каньон, обрыв, осыпь,
дельта, берег, конус, пойма, долина, хребет, плато, рифт, дюны, каменистая
пустыня, холмы, равнина. Пороги — в долях размаха, где это высота, и в м/м,
где это уклон: одни и те же на любой планете и любой сетке.
"""
