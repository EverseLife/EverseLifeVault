...
DIFFUSION = 0.03
#: 500 → 125 при ужатии планет 2026-09-10: это единственная **абсолютная
...
#: шестнадцати. Проверка: путь оплывания за прогон, `sqrt(итераций · kd) ·
#: сторона`, был 420–840 м у прежней Терры и стал 105–210 у нынешней — ровно
#: те же четыре раза.
DIFFUSION_STEP_M = 125.0
