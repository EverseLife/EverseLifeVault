...
CLASS_ROW_TABLES = (
    ...
    #: Множитель температурного запаса — по ВЕЩИ, а не по классу (D-348):
    #: «Скафандр: 3» загрузился бы молча и не сделал бы ничего. Раз сказано,
    #: что защищает всякий скафандр, третий скафандр обязан прийти со своим
    #: числом, а не с молчаливой единицей
    ("frost.suit_k", ("Скафандр", "Утеплённый костюм")),
)
