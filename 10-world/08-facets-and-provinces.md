...
> **Статус:** в реализации (стоит на D-321, D-323) · словарь имён и калибровок. С волной 7 плана ландшафта (90-production/12 §6, дополнение к D-321) строки фацетов живут как данные вольта — `data/facets.yaml`, английские имена оверлеем в `data/locales/en.yaml`, — а выбор фацета делает `engine/facet.py` по осям `biome.facet_axes`. Блок ниже — источник этих строк; правится он, и правка переносится в данные.
>
